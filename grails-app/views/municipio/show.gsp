	...
	<body>
		...
		<div id="show-municipio" class="content scaffold-show" role="main">
			...
			<ol class="property-list municipio">
				...
				<g:if test="${municipioInstance?.noMunicipio}">
				<li class="fieldcontain">
					<span id="noMunicipio-label" class="property-label"><g:message code="municipio.noMunicipio.label" default="No Municipio" /></span>
					
						<span class="property-value" aria-labelledby="noMunicipio-label"><g:fieldValue bean="${municipioInstance}" field="noMunicipio"/></span>
