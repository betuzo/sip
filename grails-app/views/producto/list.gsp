			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="noProducto" title="${message(code: 'producto.noProducto.label', default: 'No Producto')}" />
				...
				<g:each in="${productoInstanceList}" status="i" var="productoInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${productoInstance.id}">${fieldValue(bean: productoInstance, field: "noProducto")}</g:link></td>
