			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="noEstado" title="${message(code: 'estado.noEstado.label', default: 'No Estado')}" />
				...
				<g:each in="${estadoInstanceList}" status="i" var="estadoInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${estadoInstance.id}">${fieldValue(bean: estadoInstance, field: "noEstado")}</g:link></td>
					
						<td>${fieldValue(bean: estadoInstance, field: "estado")}</td>
