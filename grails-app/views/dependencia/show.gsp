	...
	<body>
		...
		<div id="show-dependencia" class="content scaffold-show" role="main">
			...
			<ol class="property-list dependencia">
				...
				<g:if test="${dependenciaInstance?.noDependencia}">
				<li class="fieldcontain">
					<span id="noDependencia-label" class="property-label"><g:message code="dependencia.noDependencia.label" default="No Dependencia" /></span>
					
						<span class="property-value" aria-labelledby="noDependencia-label"><g:fieldValue bean="${dependenciaInstance}" field="noDependencia"/></span>
				...
				<li class="fieldcontain">
					<span id="descripcion-label" class="property-label"><g:message code="dependencia.descripcion.label" default="Descripcion" /></span>
