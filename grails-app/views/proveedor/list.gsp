			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="noProveedor" title="${message(code: 'proveedor.noProveedor.label', default: 'No Proveedor')}" />
						...
						<g:sortableColumn property="nombreDelRepresentante" title="${message(code: 'proveedor.nombreDelRepresentante.label', default: 'Nombre Del Representante')}" />
				...
				<g:each in="${proveedorInstanceList}" status="i" var="proveedorInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${proveedorInstance.id}">${fieldValue(bean: proveedorInstance, field: "noProveedor")}</g:link></td>
						...
						<td>${fieldValue(bean: proveedorInstance, field: "nombreDelRepresentante")}</td>
